function results = permutation_test_cv_reference(matrix_name, behav_name, all_mats, all_behav, k, THR, covars, output_txt, results)
% -------------------------------------------------------------------------
% PERMUTATION_TEST_CV_REFERENCE
%   Runs 1000 iterations (one observed and 999 shuffled) to validate CPM models.
...
% -------------------------------------------------------------------------
    ...
    [t_r_comb, t_r_pos, t_r_neg, t_mse_comb, t_mse_pos, t_mse_neg] = ...
        CPM_core_function_reference(all_mats, all_behav, cv_fixed, THR, covars, corr_type);
    ...
    parfor it = 2:NO_ITERATIONS
        ...
        % Explicit historical process-worker generator and seed.
        rng(it + 200, 'threefry');
        ...
        [p_r_comb, p_r_pos, p_r_neg, p_mse_comb, p_mse_pos, p_mse_neg] = ...
            CPM_core_function_reference(all_mats, shuffled_behav, cv_fixed, THR, covars, corr_type);
