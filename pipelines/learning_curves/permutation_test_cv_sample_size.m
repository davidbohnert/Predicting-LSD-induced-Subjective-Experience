function [results, details] = permutation_test_cv_sample_size( ...
        matrix_name, behav_name, all_mats, all_behav, k, thresholds, covars, ...
        output_txt, results, no_iterations, cv_seed, write_text_log, ...
        max_workers, rng_settings)
%PERMUTATION_TEST_CV_SAMPLE_SIZE Shared CPM with an explicit partition seed.
...
corr_type = '';
if nargin < 13 || isempty(max_workers), max_workers = 0; end
if nargin < 14 || isempty(rng_settings)
